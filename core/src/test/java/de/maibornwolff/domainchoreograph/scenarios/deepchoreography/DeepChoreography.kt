...
@DomainDefinition
class DeepDomainObject1(val n: Int)

@DomainDefinition
class DeepDomainObject2(val n: Int)

@DomainDefinition
class DeepDomainObject3(val sum: Int) {
    companion object {
        @DomainFunction
...
@DomainDefinition
class DeepDomainObject4(val product: Double) {
    companion object {
        @DomainFunction
...
@DomainDefinition
class DeepDomainObject5(val sum: Int, val product: Double) {
    companion object {
        @DomainFunction
